package com.tchokoapps.springboot.dependencyinjectiondemo.config;
...
public class PropertyConfig {
    ...
    @Value("${tchoko.username}")
    private String user;

    @Value("${tchoko.password}")
    private String password;

    @Value("${tchoko.dburl}")
    private String url;

    @Value("${tchoko.jms.username}")
    String jmsUsername;

    @Value("${tchoko.jms.password}")
    String jmsPassoword;

    @Value("${tchoko.jms.url}")
    String jmsUrl;
